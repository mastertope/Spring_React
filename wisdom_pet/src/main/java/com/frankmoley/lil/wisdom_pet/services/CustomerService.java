...
import com.frankmoley.lil.wisdom_pet.data.repositories.CustomerRepository;
...
public class CustomerService {
    ...
    public Customer getCustomer(long id){
        Optional<CustomerEntity> entityOptional = this.customerRepository.findById(id);
        if (entityOptional.isEmpty()){
            throw new NotFoundException("customer not found with id");
        }
        return this.translateDbToWeb(entityOptional.get());
    }
